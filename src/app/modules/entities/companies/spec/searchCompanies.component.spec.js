(function() {
  ...
  describe('Search Companies', function() {
    ...
    it('should do the search', function() {
      ...
      expect($ctrl.searchCompaniesService.getCompanies).toHaveBeenCalledWith({searchText: 'mustard'}, { employees: '', fundingStage: '', fundingAmount: '', productStage: '', targetMarkets: '', businessModel: '', companyStage: '', recently_funded: '' }, { currentPage: 1, perPage: 5});
      expect($ctrl.results.length).toEqual(1);
    });
